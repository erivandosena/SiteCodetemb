<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NovoUsuario.aspx.cs" Inherits="Administrativo_Usuarios_NovoUsuario" %>
...
<body>
    ...
    <div align="center">
         <asp:CreateUserWizard ID="CreateUserWizard1" runat="server"  
                              Font-Names="Verdana"
                              Font-Size="10pt"
                              CompleteSuccessText="A conta foi criada com sucesso!<p></p>" 
                              UnknownErrorMessage="A conta não foi criada. Por favor, tente novamente."
                              OnCreatedUser="CreateUserWizard1_CreatedUser" 
             CancelButtonText="Cancela" CreateUserButtonText="Criar Usuário" 
             DuplicateEmailErrorMessage="O endereço de e-mail que você digitou já está em uso. Por favor, indique um outro endereço de e-mail." 
             DuplicateUserNameErrorMessage="Por favor, indique um nome de usuário diferente." 
             FinishCompleteButtonText="Concluir" FinishPreviousButtonText="Voltar" 
             InvalidEmailErrorMessage="igite um endereço de e-mail válido." 
             InvalidPasswordErrorMessage="Senha deve conter no mínimo {0} caracteres incluindo {1} caractere(s) não-alfanumérico(s)." 
             StartNextButtonText="Próximo" StepNextButtonText="Próximo" 
             StepPreviousButtonText="Volta"> 
            ...
            <WizardSteps>
                ...
                <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server" 
                    ...
                    <ContentTemplate>
                        ...
                        <table style="font-size: 10pt; font-family: Verdana" border="0" width="400">
                            <tr>
                                <td style="font-weight: bold; color: #333333; background-color: #FFFFFF" 
                                    align="center" colspan="2">
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="2" 
                                    style="font-weight: bold; color: #FFFFFF; background-color: #6B696B">
                                    <%= CreateUserWizardStep1.Title %></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="center" colspan="2" 
                                    style="font-weight: bold; color: #333333; background-color: #FFFFFF">
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                <td align="right">
                                    <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName">Nome de Usuário:</asp:Label></td>
                                <td>
                                    <asp:TextBox ID="UserName" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ToolTip="Nome de usuário é necessária."
                                        ErrorMessage="Nome de usuário é necessário." ValidationGroup="CreateUserWizard1" ControlToValidate="UserName">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:CompareValidator ID="PasswordCompare" runat="server" 
                                        ...
                                        Display="Dynamic" 
                                        ErrorMessage="A senha e a confirmação de senha devem corresponder." 
                ...
                <asp:WizardStep runat="server" ID="wsAssignUserToRoles" AllowReturn="False" Title="3º Passo -  Atribuir regras ao usuário"
                            ...
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Button ID="ContinueButton" runat="server" CausesValidation="False" 
                                        CommandName="Continue" onclientclick="window.open('../Default.aspx','_parent')" 
            ...
            <MailDefinition BodyFileName="~/HtmlDadosAcesso.html" IsBodyHtml="True" 
                Subject="Seus dados para acesso ">
            </MailDefinition>
